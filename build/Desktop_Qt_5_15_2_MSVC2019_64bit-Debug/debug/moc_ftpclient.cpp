...
QT_MOC_LITERAL(1, 10, 16), // "downloadFinished"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 9), // "imageData"
QT_MOC_LITERAL(4, 38, 13), // "downloadError"
QT_MOC_LITERAL(5, 52, 11), // "errorString"
QT_MOC_LITERAL(6, 64, 18), // "onDownloadFinished"
QT_MOC_LITERAL(7, 83, 14), // "QNetworkReply*"
QT_MOC_LITERAL(8, 98, 5) // "reply"

    },
    "FtpClient\0downloadFinished\0\0imageData\0"
    "downloadError\0errorString\0onDownloadFinished\0"
...
void FtpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->downloadError((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (FtpClient::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FtpClient::downloadFinished)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FtpClient::downloadError)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FtpClient::downloadFinished(const QByteArray & _t1)
{
...
// SIGNAL 1
void FtpClient::downloadError(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
